...
// ==================== CẤU HÌNH WIFI & DASHBOARD ====================
#define WIFI_SSID "VIETSET_TECH"
#define WIFI_PASS "vs68686868"

// Bỏ comment dòng dưới nếu muốn cấp IP Tĩnh (Static IP) thay vì IP Động (DHCP)
// #define WIFI_USE_STATIC_IP
#define WIFI_STATIC_IP_ADDR  192, 168, 1, 150
#define WIFI_GATEWAY_ADDR    192, 168, 1, 1
